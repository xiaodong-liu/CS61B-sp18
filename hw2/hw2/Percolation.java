...
public class Percolation {
    ...
    public Percolation(int N) {
        ...
        noBottom = new WeightedQuickUnionUF(N * N + 2);
        up = N * N;
        bottom = N * N + 1;
        this.N = N;
    ...
    private void connectNeighbours(int row, int col) {
        ...
        if ((row - 1 >= 0) && isOpen(row - 1, col)) {
            ...
            noBottom.union(currentIndex, N * (row - 1) + col);
        }
        ...
        if ((col - 1 >= 0) && isOpen(row, col - 1)) {
            ...
            noBottom.union(currentIndex, N * row + col - 1);
        }
    ...
    public boolean isFull(int row, int col) {
        ...
        return noBottom.connected(N * row + col, up);
    }
